...
public class OrderWrapper implements Comparable<OrderWrapper> {
    ...
    public static void testNew(List<String> list){
        List<OrderWrapper> chinesesOrderList = new ArrayList<OrderWrapper>();
        for (String s : list) {
            chinesesOrderList.add(new OrderWrapper(s));
        }

//        chinesesOrderList.add(new OrderWrapper("第03话"));
//        chinesesOrderList.add(new OrderWrapper("第02话"));
//        chinesesOrderList.add(new OrderWrapper("第01话"));
